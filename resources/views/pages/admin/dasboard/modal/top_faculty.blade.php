<div class="modal fade modal-lg" id="topratedfaculty" data-bs-keyboard="false" data-bs-backdrop="static">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="pb-4 fs-5">Faculty Name: <span class="fw-semibold fs-5 text-capitalize"
                        id="naem_faculty_top_rated"></span>
                </div>
                ...
                <div id="view_faculty_score_table_top_rated">
                    {{-- table here --}}
